...
- Optional: Pfad zur Kürzel-Referenz `./references/categories/firma-kuerzel.md` aus dem Plugin.
...
- Zweite Quelle: Kürzel-Referenz (`./references/categories/firma-kuerzel.md`).
